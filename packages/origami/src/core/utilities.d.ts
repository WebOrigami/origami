...
export function getScope(graph: AsyncDictionary|null): Explorable;
export function graphInContext(graph: GraphVariant, context: AsyncDictionary|null): Explorable & { parent: Explorable };
