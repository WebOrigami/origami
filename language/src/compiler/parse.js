...
function peg$parse(input, options) {
  ...
  var peg$f45 = function(identifier, port, slashFollows) {
  ...
  var peg$f76 = function(identifier) {
      return annotate(
  ...
  var peg$f89 = function(identifier, slashFollows) {
