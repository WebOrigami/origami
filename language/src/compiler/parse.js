...
function peg$parse(input, options) {
  ...
  var peg$f39 = function(values) {
      return annotate(values, location());
    };
  var peg$f40 = function() {
      return annotate([ops.literal, parseInt(text())], location());
    };
  var peg$f41 = function(values) {
      return annotate(values, location());
    };
  ...
  var peg$f50 = function(key, pipeline) {
      return annotate(
        makeProperty(key, annotate([ops.getter, pipeline], location())),
        location()
      );
    };
  var peg$f51 = function(hiddenKey) { return hiddenKey.join(""); };
  var peg$f52 = function(key, pipeline) {
  ...
  var peg$f54 = function(identifier, slash) {
    return identifier + (slash ?? "");
  };
  var peg$f55 = function(string) {
  ...
  var peg$f61 = function(fn, host, path) {
      const keys = annotate([host, ...(path ?? [])], location());
      return makeCall(fn, keys);
    };
  var peg$f62 = function(fn, reference) {
  ...
  var peg$f66 = function(identifier, slashFollows) {
  ...
  var peg$f80 = function(operator, expression) {
