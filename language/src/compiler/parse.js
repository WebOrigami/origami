...
function peg$parse(input, options) {
  ...
  var peg$f80 = function(flags) {
      return flags.join("");
    };
  var peg$f81 = function(chars, flags) {
  ...
  var peg$f85 = function(identifier, slashFollows) {
