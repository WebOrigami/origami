...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = {
    ...
    homeDirectory: peg$parsehomeDirectory,
    host: peg$parsehost,
    identifier: peg$parseidentifier,
    identifierChar: peg$parseidentifierChar,
    implicitParenthesesCallExpression:
      peg$parseimplicitParenthesesCallExpression,
    ...
    pathKey: peg$parsepathKey,
    pathSegment: peg$parsepathSegment,
    pathSegmentChar: peg$parsepathSegmentChar,
    pipelineExpression: peg$parsepipelineExpression,
    primary: peg$parseprimary,
    program: peg$parseprogram,
    protocolExpression: peg$parseprotocolExpression,
    qualifiedReference: peg$parsequalifiedReference,
    inherited: peg$parseinherited,
    relationalExpression: peg$parserelationalExpression,
    relationalOperator: peg$parserelationalOperator,
    rootDirectory: peg$parserootDirectory,
    scopeReference: peg$parsescopeReference,
  ...
  var peg$f23 = function () {
    error(
      `An object ended without a closing brace, or contained something that wasn't expected.\nThe top level of an object can only contain definitions ("a: b" or "a = b") or spreads ("...a").`
    );
  };
  ...
  var peg$f30 = function (left, right) {
    return right
      ? annotate([ops.exponentiation, left, right], location())
      : left;
  };
  ...
  var peg$f43 = function (head, tail) {
    return tail.length === 0
      ...
      : annotate(
          [
            ops.logicalAnd,
            downgradeReference(head),
            ...makeDeferredArguments(tail),
          ],
          location()
        );
  };
  ...
  var peg$f52 = function (hiddenKey) {
    return hiddenKey.join("");
  };
  ...
  var peg$f79 = function (head, tail) {
    ...
    return annotate(
      [
        ops.lambda,
        lambdaParameters,
        makeTemplate(ops.templateIndent, head, tail, location()),
      ],
      location()
    );
  };
  ...
  var peg$f82 = function (front, body) {
    return front
