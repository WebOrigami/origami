...
function peg$parse(input, options) {
  ...
  var peg$e9 = peg$otherExpectation("function call");
  ...
  var peg$e19 = peg$otherExpectation("double quote string");
  ...
  var peg$e27 = peg$otherExpectation("backslash-escaped character");
  ...
  var peg$e37 = peg$otherExpectation("floating-point number");
  var peg$e38 = peg$literalExpectation(".", false);
  var peg$e39 = peg$otherExpectation("parenthetical group");
  var peg$e40 = peg$otherExpectation("guillemet string");
  var peg$e41 = peg$literalExpectation("\xAB", false);
  var peg$e42 = peg$literalExpectation("\xBB", false);
  var peg$e43 = peg$literalExpectation("~", false);
  var peg$e44 = peg$otherExpectation("HTTP/HTTPS host");
  var peg$e45 = peg$otherExpectation("identifier");
  var peg$e46 = peg$classExpectation(["(", ")", "{", "}", "[", "]", "<", ">", "?", "!", "&", "|", "-", "=", ",", "/", ":", "`", "\"", "'", "\xAB", "\xBB", "\\", " ", "\u2192", "\u21D2", "\t", "\n", "\r"], true, false);
  var peg$e47 = peg$literalExpectation("-", false);
  var peg$e48 = peg$literalExpectation(">", false);
  var peg$e49 = peg$otherExpectation("function call with implicit parentheses");
  var peg$e50 = peg$classExpectation([" ", "\t"], false, false);
  var peg$e51 = peg$otherExpectation("integer");
  var peg$e52 = peg$otherExpectation("list");
  ...
  var peg$e76 = peg$otherExpectation("function arguments in parentheses");
  var peg$e77 = peg$otherExpectation("slash-separated path");
  var peg$e78 = peg$classExpectation(["(", ")", "{", "}", "[", "]", ",", ":", "/", "\\", " ", "\t", "\n", "\r"], true, false);
  var peg$e79 = peg$otherExpectation("Origami program");
  ...
  var peg$e85 = peg$otherExpectation("lambda function");
  var peg$e86 = peg$literalExpectation("\u2192", false);
  var peg$e87 = peg$literalExpectation("->", false);
  var peg$e88 = peg$otherExpectation("single quote string");
  var peg$e89 = peg$literalExpectation("'", false);
  var peg$e90 = peg$otherExpectation("string");
  var peg$e91 = peg$otherExpectation("template");
  var peg$e92 = peg$literalExpectation("${", false);
  var peg$e93 = peg$otherExpectation("template text");
  var peg$e94 = peg$otherExpectation("template literal");
  var peg$e95 = peg$literalExpectation("`", false);
  var peg$e96 = peg$otherExpectation("template substitution");
  ...
  var peg$f4 = function(parameters, pipeline) {
  ...
  var peg$f12 = function(condition, truthy, falsy) {
      return annotate([
        ops.conditional,
  ...
  var peg$f27 = function(identifier, port, slashFollows) {
  ...
  var peg$f29 = function(list) {
      return annotate(list, location());
    };
  var peg$f30 = function(head, args) {
      return args ? makeCall(head, args) : head;
    };
  var peg$f31 = function(values) {
  ...
  var peg$f42 = function(key, pipeline) {
      return annotate(
        makeProperty(key, annotate([ops.getter, pipeline], location())),
        location()
      );
    };
  var peg$f43 = function(hiddenKey) { return hiddenKey.join(""); };
  var peg$f44 = function(key, pipeline) {
      return annotate(makeProperty(key, pipeline), location());
    };
  var peg$f45 = function(key) {
      return annotate([key, [ops.inherited, key]], location());
    };
  var peg$f46 = function(identifier, slash) {
    return identifier + (slash ?? "");
  };
  var peg$f47 = function(string) {
  ...
  var peg$f49 = function(list) {
      return annotate(list ?? [undefined], location());
    };
  var peg$f50 = function(segments) {
  ...
  var peg$f52 = function(chars, slashFollows) {
  ...
  var peg$f61 = function(definition) {
  ...
  var peg$f71 = function(operator, expression) {
