...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = {
    ...
    angleBracketPathKey: peg$parseangleBracketPathKey,
    angleBracketPathChar: peg$parseangleBracketPathChar,
    angleBracketProtocol: peg$parseangleBracketProtocol,
    ...
    jseMode: peg$parsejseMode,
    jsIdentifier: peg$parsejsIdentifier,
    jsIdentifierPart: peg$parsejsIdentifierPart,
    jsIdentifierStart: peg$parsejsIdentifierStart,
    jsPropertyAccess: peg$parsejsPropertyAccess,
    jsReference: peg$parsejsReference,
    list: peg$parselist,
    ...
    primaryJse: peg$parseprimaryJse,
    primaryShell: peg$parseprimaryShell,
    ...
    whitespaceShell: peg$parsewhitespaceShell,
  ...
  var peg$f52 = function (char) {
    return char.match(/[$_\p{ID_Continue}]/u);
  };
  var peg$f53 = function (char) {
    return char.match(/[$_\p{ID_Start}]/u);
  };
  ...
  var peg$f67 = function (hiddenKey) {
