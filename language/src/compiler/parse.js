...
function peg$parse(input, options) {
  ...
  var peg$e5 = peg$otherExpectation("function arguments");
  var peg$e6 = peg$otherExpectation("array");
  ...
  var peg$e14 = peg$otherExpectation("function call");
  ...
  var peg$e22 = peg$otherExpectation("double quote string");
  ...
  var peg$e30 = peg$otherExpectation("backslash-escaped character");
  ...
  var peg$e42 = peg$literalExpectation("\xBB", false);
  var peg$e43 = peg$literalExpectation("'", false);
  var peg$e44 = peg$literalExpectation("**", false);
  var peg$e45 = peg$otherExpectation("floating-point number");
  var peg$e46 = peg$literalExpectation(".", false);
  var peg$e47 = peg$literalExpectation("---\n", false);
  var peg$e48 = peg$otherExpectation("YAML front matter");
  var peg$e49 = peg$otherExpectation("parenthetical group");
  var peg$e50 = peg$otherExpectation("guillemet string");
  var peg$e51 = peg$literalExpectation("\xAB", false);
  var peg$e52 = peg$literalExpectation("~", false);
  var peg$e53 = peg$otherExpectation("HTTP/HTTPS host");
  var peg$e54 = peg$otherExpectation("identifier");
  var peg$e55 = peg$classExpectation(["(", ")", "{", "}", "[", "]", "<", ">", "?", "!", "|", "-", "=", ",", "/", ":", "`", "\"", "'", "\xAB", "\xBB", "\\", "\u2192", "\u21D2", "\u2026", " ", "\t", "\n", "\r"], true, false);
  ...
  var peg$e60 = peg$otherExpectation("JavaScript identifier continuation");
  var peg$e61 = peg$otherExpectation("JavaScript identifier start");
  var peg$e62 = peg$otherExpectation("identifier reference");
  ...
  var peg$e73 = peg$otherExpectation("number");
  var peg$e74 = peg$literalExpectation("??", false);
  var peg$e75 = peg$otherExpectation("object literal");
  var peg$e76 = peg$literalExpectation("{", false);
  var peg$e77 = peg$otherExpectation("object getter");
  var peg$e78 = peg$literalExpectation("=", false);
  var peg$e79 = peg$otherExpectation("object key");
  var peg$e80 = peg$otherExpectation("object property");
  var peg$e81 = peg$otherExpectation("object identifier");
  ...
  var peg$e89 = peg$otherExpectation("scope reference");
  ...
  var peg$e95 = peg$otherExpectation("lambda function");
  var peg$e96 = peg$literalExpectation("\u2192", false);
  var peg$e97 = peg$literalExpectation("->", false);
  var peg$e98 = peg$otherExpectation("single quote string");
  var peg$e99 = peg$otherExpectation("string");
  var peg$e100 = peg$otherExpectation("template");
  var peg$e101 = peg$literalExpectation("${", false);
  var peg$e102 = peg$otherExpectation("template text");
  var peg$e103 = peg$otherExpectation("template document");
  var peg$e104 = peg$otherExpectation("template literal");
  var peg$e105 = peg$otherExpectation("template substitution");
  ...
  var peg$f4 = function() { return options.mode === "shell" };
  ...
  var peg$f16 = function(condition, tail) {
      if (!tail) {
        return condition;
      }
  ...
  var peg$f44 = function(identifier, port, slashFollows) {
  ...
  var peg$f47 = function() { return options.mode === "shell" };
  ...
  var peg$f61 = function(entries) {
      return makeObject(entries ?? [], location());
    };
  var peg$f62 = function(entries) {
      return annotate(entries, location());
    };
  var peg$f63 = function(key, pipeline) {
      return annotate(
        makeProperty(key, annotate([ops.getter, pipeline], location())),
        location()
      );
    };
  var peg$f64 = function(hiddenKey) { return hiddenKey.join(""); };
  ...
  var peg$f67 = function(identifier, slash) {
    return identifier + (slash ?? "");
  };
  var peg$f68 = function(string) {
    // Remove `ops.literal` from the string code
    return string[1];
  };
  var peg$f69 = function(identifier) {
      return annotate([ops.literal, identifier], location());
    };
  var peg$f70 = function(list) {
      return annotate(list, location());
    };
  var peg$f71 = function(identifier) {
      return annotate(
        [annotate([ops.literal, identifier], location())],
        location()
      );
    };
  var peg$f72 = function(list) {
      return annotate(list ?? [undefined], location());
    };
  var peg$f73 = function(segments) {
  ...
  var peg$f75 = function(chars, slashFollows) {
    // Append a trailing slash if one follows (but don't consume it)
    const key = chars.join("") + (slashFollows ? "/" : "");
    return annotate([ops.literal, key], location());
  };
  ...
  var peg$f77 = function() { return options.mode === "jse" };
  var peg$f78 = function() { return options.mode === "shell" };
  var peg$f79 = function(fn, host, path) {
      const keys = annotate([host, ...(path ?? [])], location());
      return makeCall(fn, keys);
    };
  var peg$f80 = function(fn, reference) {
  ...
  var peg$f97 = function(front, body) {
  ...
  var peg$f102 = function(operator, expression) {
      return makeUnaryOperation(operator, expression, location());
    };
  var peg$f103 = function() { return options.mode === "shell" };
  var peg$f104 = function() { return options.mode === "jse" };
  ...
  function peg$parseangleBracketPath() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          s6 = [];
          s7 = peg$parseangleBracketPathKey();
          while (s7 !== peg$FAILED) {
            s6.push(s7);
            s7 = peg$currPos;
            if (input.charCodeAt(peg$currPos) === 47) {
            ...
            if (s8 !== peg$FAILED) {
              s8 = peg$parseangleBracketPathKey();
              if (s8 === peg$FAILED) {
                peg$currPos = s7;
                s7 = peg$FAILED;
              } else {
