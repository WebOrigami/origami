...
function peg$parse(input, options) {
  ...
  var peg$f69 = function(hiddenKey) { return hiddenKey.join(""); };
  ...
  var peg$f96 = function(dotChains, trailingSlash) {
