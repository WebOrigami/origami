...
function peg$parse(input, options) {
  ...
  var peg$e92 = peg$otherExpectation("scope reference");
  ...
  var peg$f48 = function() { return options.mode === "jse" };
  ...
  var peg$f86 = function() { return options.mode === "shell" };
